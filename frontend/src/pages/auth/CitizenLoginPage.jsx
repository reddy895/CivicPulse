    ...
    <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="card-coffee p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="citizen-email" type="email" value={email} onChange={e => setEmail(e.target.value)}
                  placeholder="you@example.com" className="form-input pl-10" autoComplete="email" required />
              </div>
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input id="citizen-password" type={showPw ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)}
                  placeholder="••••••••" className="form-input pl-10 pr-10" autoComplete="current-password" required />
                <button type="button" onClick={() => setShowPw(v => !v)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--text-tertiary)] cursor-pointer hover:text-[var(--text-primary)]">
          ...
          <button onClick={handleDemo} className="btn-secondary w-full justify-center text-sm">
